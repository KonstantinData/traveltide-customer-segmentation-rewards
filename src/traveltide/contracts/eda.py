...
# NOTE:
# The S3 Bronze layer uses UUID-like IDs for session_id/trip_id in many exports.
# Therefore we validate them as strings (not int64).
# user_id is kept as Int64 (typical TravelTide dataset uses numeric user IDs).
# If your S3 export uses UUIDs for user_id too, switch user_id to pa.String.
...
SESSION_RAW_SCHEMA = DataFrameSchema(
    {
        ...
        # S3 exports may have missing/empty values -> allow null
